      ...
      resultsEl.innerHTML = `
        <div class="fs-not-configured">
          ...
          <div class="fs-not-configured-desc">
            Add <code>SERPAPI_KEY</code> to your Vercel environment variables to enable in-app results
            powered by real Google Flights data.<br>
            Register free (100 searches/month) at
...
function renderFlightResults() {
  ...
  container.innerHTML = `
    <div class="fs-results-header">
      ...
      <span class="fs-results-note">ℹ️ Live prices via Google Flights</span>
